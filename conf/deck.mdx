...
* Understand what the virtual DOM and what are it's components
...
Facebook introduced JSX along with the vritual DOM, giving us the ability to add HTML inside javascript
