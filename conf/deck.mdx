...
The Virtual DOM is an abstraction layer over the browser DOM
...
<ul style={{ textAlign: 'left' }}>
  <Appear>
    <li>The virtual DOM allows us to represent the DOM tree using familiar Javascript instead of the messy browser DOM API.</li>
    <li>This makes traversing, diffing and changing the tree quicker and easier.</li>
...
It is! Thankfully, by looking at the code base of many of the most popular frontend frameworks, we can get a good understanding of how they work and apply that knowledge by building a framework ourselves.
...
This make the virtual tree dynamic, but also adds the complexity of having to patch the DOM.
...
I was able to extract three general types of diffing algorithms.
...
To make sure we are ready for JSX, let's follow the standard of `react.createElement` for our factory.
...
<CodeSurfer
    ...
    steps={[
        ...
        { range: [8, 11], notes: `If not or they're different, we update our known node` },
...
Hooks are the newest feature from React that allows us to add state to function components as if they were a class component, but how to they work exactly?
